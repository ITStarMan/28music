...
$apikey='f11ac4469164080f2459c7e3367867e6';  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）

$mobile=$_POST['mobile'];  //手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。
...
$content='您的注册验证码是：'.$num.'，有效期十分钟，请及时验证。【三加】';  //要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。
...
echo $num;  //输出result内容，查看返回值，成功为success，错误为error，（错误内容在上面有显示）
